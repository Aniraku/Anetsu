...
function dbRowToMedia(row) {
  return {
    __typename: 'Media',
    id: row.id,
    title: { romaji: row.title_romaji, english: row.title_english, native: row.title_native, userPreferred: row.title_user_preferred, __typename: 'MediaTitle' },
    coverImage: { large: row.cover_large, medium: row.cover_medium, color: row.cover_color, extraLarge: row.cover_large, __typename: 'CoverImage' },
    ...
    airingSchedule: row.airing_schedule,
    genres: row.genres || [],
    tags: row.tags || [],
    studios: row.studios || [],
    ...
    streamingEpisodes: row.streaming_episodes || [],
